...
const Carousel = () => {
  ...
  return (
    ...
    <div className="Carousel-sectionText">
      <h1 className='carousel-h1' data-aos='fade-up'>
        Travel :<span id='orange'>Wonders</span><span id='blue'>Of</span><span id='green'>Bharat</span>!
      </h1>
      <p className='carousel-para' data-aos='fade-up'>
        Discover the India's most adventurous nature, life is short for a trip.
      </p>
      <a href="/packages">
      ...
      <div className="carousel-content">
        ...
        <div className="slider">
          <div className="carousel-images flex slide-track" data-aos='fade-up'>
            <div className="carousel-slide w-full sm:w-1/2 md:w-1/4">
              <img className='carousel-slide-img' src={image1} alt="PopularPlace1" />
            </div>
            <div className="carousel-slide w-full sm:w-1/2 md:w-1/4">
              <img className='carousel-slide-img' src={image2} alt="PopularPlace2" />
            </div>
            <div className="carousel-slide w-full sm:w-1/2 md:w-1/4">
              <img className='carousel-slide-img' src={image3} alt="PopularPlace3" />
            </div>
            <div className="carousel-slide w-full sm:w-1/2 md:w-1/4">
              <img className='carousel-slide-img' src={image4} alt="PopularPlace4" />
            </div>
          </div>
        </div>
      </div>
