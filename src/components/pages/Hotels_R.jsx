...
const Hotels = ({ setFavourites }) => {
    ...
    const handleSubmit = (e) => {
        ...
        Swal.fire('Success','Hotel booked successfully!','success')
    ...
    return (
        <>
                ...
                <div className="flex justify-center mb-4">
                    {types.map(type => (
                        <button
                            ...
                            className={`m-1 px-4 py-2 rounded-lg border-2 transition-all ${selectedType === type.value
                        ...
                        {loading ? (
                            ...
                            hotels.map(hotel => (
                                <div key={hotel.id} className="border p-4 rounded-md shadow-md flex flex-col h-full">
                                    ...
                                    <button className="mt-auto px-4 py-2 bg-[#600180] text-white rounded-md transition-colors duration-200 hover:bg-[#A040A0]"
            ...
            >
                <div className="bg-white rounded-lg shadow-lg p-8 max-h-screen overflow-y-auto w-full max-w-md relative sm:max-w-sm md:max-w-md lg:max-w-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            className="w-full px-4 py-2 bg-[#600180] text-white rounded-md hover:bg-gray-300 text-black"
                        >
                            Book Now
                        </button>
                    </form>
